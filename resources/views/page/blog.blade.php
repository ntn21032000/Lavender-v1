            ...
            <div class="col-12 col-lg-6">
                <div class="single-blog-area mb-50">
                    ...
                    <div class="post-title">
                        <a target="_self" href="#">Vivamus sed nunc in arcu cursus mollis quis et orci. Interdum et malesuada</a>
                    </div>
                    <!-- Hover Content -->
                    <div class="hover-content">
                        ...
                        <a target="_self" href="#">Continue reading <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
